...
public class LoadStateKey implements Comparable<LoadStateKey> {

	private String _table;
	private String _database;

	public LoadStateKey(String table, String database) {
		super();
		this._table = table;
	...
	@Override
	public int compareTo(LoadStateKey other) {
		if (this == other) 
			return 0;
		if (other == null) 
			return -1;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LoadStateKey other = (LoadStateKey) obj;
