...
hive -e "Drop table MES.BuildRecordALL"
...
hive -e "Drop table MES.InventoryLabelALL"
...
hive -e "Drop table MES.InventoryPackALL"
...
hive -e "Drop table MES.LocationALL"

hive -e "Create External table IF NOT EXISTS MES.LocationALL (LocationID int, Location varchar(508), LocationTypeID smallint, IsRetired tinyint, MaxQuantity float, LocationCode varchar(100), Description varchar(508), LocationType varchar(100), LocationTypeCode varchar(100),  org_id int, org_name varchar(10)) row format delimited fields terminated by ',' lines terminated by '\n' stored as textfile location '/MES/LocationALL'"
...
hive -e "Drop table MES.MachineStageALL"
...
hive -e "Drop table MES.MachineStopALL"
