...
hadoop fs -test -d /MEStwo/MachineStop/1
    if [ $? = 0 ]
        then
 			echo " "
 			echo "/MEStwo/MachineStop already ingested for 1"
 			echo " "
        else
			STARTTIME=$SECONDS
...
hadoop fs -test -d /MEStwo/MachineStop/2
    if [ $? = 0 ]
        then
 			echo " "
 			echo "/MEStwo/MachineStop already ingested for 2"
 			echo " "
        else
			STARTTIME=$SECONDS
...
hadoop fs -test -d /MEStwo/MachineStop/3
    if [ $? = 0 ]
        then
 			echo " "
 			echo "/MEStwo/MachineStop already ingested for 3"
 			echo " "
        else
			STARTTIME=$SECONDS
...
hadoop fs -test -d /MEStwo/MachineStop/4
    if [ $? = 0 ]
        then
 			echo " "
 			echo "/MEStwo/MachineStop already ingested for 4"
 			echo " "
        else
			STARTTIME=$SECONDS
...
hadoop fs -test -d /MEStwo/MachineStop/5
    if [ $? = 0 ]
        then
 			echo " "
 			echo "/MEStwo/MachineStop already ingested for 5"
 			echo " "
        else
			STARTTIME=$SECONDS
